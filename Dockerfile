...
RUN apt-get update && apt-get install -y --no-install-recommends \
  ...
  && ln -sf /usr/lib/x86_64-linux-gnu/libicui18n.so.72 /usr/lib/x86_64-linux-gnu/libicui18n.so.74 \
  && ln -sf /usr/lib/x86_64-linux-gnu/libicuuc.so.72   /usr/lib/x86_64-linux-gnu/libicuuc.so.74 \
  && ln -sf /usr/lib/x86_64-linux-gnu/libicudata.so.72 /usr/lib/x86_64-linux-gnu/libicudata.so.74
