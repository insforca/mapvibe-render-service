...
function textMetrics(w: any, h: any, layout: any){if(layout==='editorial'){var x=w*.06;return{cX:x,cY:h*.82,dX:x,dY:h*.855,coX:x,coY:h*.885,crX:x,crY:h*.92,al:'left',dW:120};}var cx=w*.5;return{cX:cx,cY:h*.860,dX:cx,dY:h*.901,coX:cx,coY:h*.930,crX:cx,crY:h*.958,al:'center',dW:w*.2};}
