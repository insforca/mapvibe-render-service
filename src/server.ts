...
function applyFades(ctx: any, W: any, H: any, color: any, fs: any){// 'fullbleed' is the canonical Option 4 name; maps to the bottom-only fade path
if(fs==='fullbleed')fs='default';
